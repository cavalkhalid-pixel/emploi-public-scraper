...
CATEGORIES = [
    {"name": "Concours de recrutement", "slug": "concours-liste"},
    {"name": "Emplois supérieurs", "slug": "emploi-sup-liste"},
    {"name": "Postes de responsabilités", "slug": "postes-respo-liste"},
    {"name": "Recrutement des experts", "slug": "experts-liste"}
]
...
# On conserve le fichier des vues mais on ne l'utilise pas pour filtrer
